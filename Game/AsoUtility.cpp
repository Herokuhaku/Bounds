...
Float3 AsoUtility::RotXZPos(Float3 centerPos, Float3 radiusPos, double rad)
{
    // 実装しなくてよい
...
double AsoUtility::Magnitude(Float3 v)
{
    return sqrt((v.x * v.x) + (v.y * v.y) + (v.z * v.z));
}

double AsoUtility::Distance(Float3 v1, Float3 v2)
{
